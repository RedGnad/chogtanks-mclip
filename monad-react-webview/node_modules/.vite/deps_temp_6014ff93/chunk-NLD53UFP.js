...
var ICONS = {
  add: async () => (await import("./add-KPAKC45K.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-P3DSYWBD.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-HU2GPCLV.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-FWNMUP4U.js")).appStoreSvg,
  apple: async () => (await import("./apple-GVEWN6BS.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-PCSAKWOE.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-UTBDMXKR.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-OJ7RPDUS.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-LUTA4F6Z.js")).arrowTopSvg,
  bank: async () => (await import("./bank-XTCRYB35.js")).bankSvg,
  browser: async () => (await import("./browser-AVVGG67T.js")).browserSvg,
  card: async () => (await import("./card-2NVBHOBW.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-2QIZILXA.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-RZ7KK4UF.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-RCIDS5JJ.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-WFBP2USF.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-RTDZQNOO.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-L74EYE32.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-6HUK77M7.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-QBCJ74QG.js")).clockSvg,
  close: async () => (await import("./close-RU5RPXQS.js")).closeSvg,
  compass: async () => (await import("./compass-KWNYJYNM.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-BQIVGPBM.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-BVUVNR43.js")).copySvg,
  cursor: async () => (await import("./cursor-R2WTSC4H.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-4XRHE3AG.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-A2YPRLKD.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-FNLNMCWJ.js")).disconnectSvg,
  discord: async () => (await import("./discord-F5ZUTWNQ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-CXJ5LJGY.js")).etherscanSvg,
  extension: async () => (await import("./extension-GMFIYZ7H.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-F3IBA7QJ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-JSHDG5FR.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-BTQRJREH.js")).farcasterSvg,
  filters: async () => (await import("./filters-4XSHQOZ7.js")).filtersSvg,
  github: async () => (await import("./github-VHY5INCU.js")).githubSvg,
  google: async () => (await import("./google-KDEN7KT2.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-M6FXB4W3.js")).helpCircleSvg,
  image: async () => (await import("./image-QIRGHRCB.js")).imageSvg,
  id: async () => (await import("./id-O6W2NI5A.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-5IEPRHVC.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-4HUMNL4G.js")).lightbulbSvg,
  mail: async () => (await import("./mail-B2SDD523.js")).mailSvg,
  mobile: async () => (await import("./mobile-X2JCM3BB.js")).mobileSvg,
  more: async () => (await import("./more-QSIP32NW.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-A7RJJPTP.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-KVZCBEPR.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-HOSNXOVA.js")).offSvg,
  playStore: async () => (await import("./play-store-UZCUPDSV.js")).playStoreSvg,
  plus: async () => (await import("./plus-RORLGXYU.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-WAGAJJKR.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-73IRLCBN.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-EO27ALYP.js")).refreshSvg,
  search: async () => (await import("./search-EJ3XLS3H.js")).searchSvg,
  send: async () => (await import("./send-ILQCE7P4.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-YHZLTYFF.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-G5GO4MWT.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-XDNTAZTG.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-VDYMBTRZ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-WLNCISUL.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-M7UXGCNU.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-Q6AMAGRJ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-DO5UBAEH.js")).twitchSvg,
  twitter: async () => (await import("./x-J247T7F6.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-XORG7FCQ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-XMWNFBCN.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-PT4UWKWX.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-GTFK5CEQ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-Q36RWZOM.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-Q36RWZOM.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-Q36RWZOM.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-OUVQ6CRE.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-7NTNNWHL.js")).warningCircleSvg,
  x: async () => (await import("./x-J247T7F6.js")).xSvg,
  info: async () => (await import("./info-D4DQOUXJ.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-JMLEZDNG.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-FN6OD7YW.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NLD53UFP.js.map
