...
function encodeString(value) {
  ...
  for (let i = 0; i < partsLength; i++) {
    parts.push(padHex(slice2(hexValue, i * 32, (i + 1) * 32), {
      dir: "right"
    }));
  }
  return {
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value = bytesToHex2(cursor.readBytes(Number.parseInt(size4), 32));
  return [value, 32];
}
...
function decodeErrorResult(parameters) {
  ...
  const signature = slice2(data, 0, 4);
  if (signature === "0x")
    throw new AbiDecodingZeroDataError();
  ...
  return {
    abiItem,
    args: "inputs" in abiItem && abiItem.inputs && abiItem.inputs.length > 0 ? decodeAbiParameters(abiItem.inputs, slice2(data, 4)) : void 0,
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-3KCS2JL5.js");
...
function decodeFunctionData(parameters) {
  ...
  return {
    ...
    args: "inputs" in description && description.inputs && description.inputs.length > 0 ? decodeAbiParameters(description.inputs, slice2(data, 4)) : void 0
  };
}
...
*/
//# sourceMappingURL=chunk-6RD3X2JP.js.map
