...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i3 = "second", s2 = "minute", u2 = "hour", a = "day", o2 = "week", c3 = "month", f6 = "quarter", h4 = "year", d2 = "date", l4 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y4 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        var r3 = 12 * (n3.year() - e3.year()) + (n3.month() - e3.month()), i4 = e3.clone().add(r3, c3), s3 = n3 - i4 < 0, u3 = e3.clone().add(r3 + (s3 ? -1 : 1), c3);
        return +(-(r3 + (n3 - i4) / (s3 ? i4 - u3 : u3 - i4)) || 0);
      }, a: function(t3) {
        return t3 < 0 ? Math.ceil(t3) || 0 : Math.floor(t3);
      }, p: function(t3) {
        return { M: c3, y: h4, w: o2, d: a, D: d2, h: u2, m: s2, s: i3, ms: r2, Q: f6 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D = {};
      D[g] = M3;
      ...
      var _ = function() {
        ...
        return m3.parse = function(t3) {
          ...
          var n3 = this, r3 = !!b.u(e3) || e3, f7 = b.p(t3), l5 = function(t4, e4) {
          ...
          var n3, o3 = b.p(t3), f7 = "set" + (this.$u ? "UTC" : ""), l5 = (n3 = {}, n3[a] = f7 + "Date", n3[d2] = f7 + "Date", n3[c3] = f7 + "Month", n3[h4] = f7 + "FullYear", n3[u2] = f7 + "Hours", n3[s2] = f7 + "Minutes", n3[i3] = f7 + "Seconds", n3[r2] = f7 + "Milliseconds", n3)[o3], $2 = o3 === a ? this.$D + (e3 - this.$W) : e3;
          if (o3 === c3 || o3 === h4) {
          ...
          var $2 = b.p(f7), y5 = function(t3) {
            var e3 = O2(l5);
            return b.w(e3.date(e3.date() + Math.round(t3 * r3)), l5);
          };
          ...
          var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b.z(this), s3 = this.$H, u3 = this.$m, a2 = this.$M, o3 = n3.weekdays, c4 = n3.months, f7 = n3.meridiem, h5 = function(t4, n4, i5, s4) {
            ...
            return r4 || function(t5) {
              switch (t5) {
                ...
                case "MM":
                  return b.s(a2 + 1, 2, "0");
                case "MMM":
                  return h5(n3.monthsShort, a2, c4, 3);
                case "MMMM":
                  return h5(c4, a2);
                case "D":
                  return e3.$D;
      ...
      return O2.prototype = k2, [["$ms", r2], ["$s", i3], ["$m", s2], ["$H", u2], ["$W", a], ["$M", c3], ["$y", h4], ["$D", d2]].forEach(function(t3) {
        k2[t3[1]] = function(e3) {
    ...
    !function(r2, e2) {
      ...
      return function(r2, e2, t2) {
        ...
        t2.en.relativeTime = o2, n2.fromToBase = function(e3, n3, i4, d3, u2) {
          for (var f6, a, s2, l4 = i4.$locale().relativeTime || o2, h4 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h4.length, c3 = 0; c3 < m2; c3 += 1) {
            var y4 = h4[c3];
...
P.cmp = function(y4) {
  var isneg, x = this, xc2 = x.c, yc2 = (y4 = new x.constructor(y4)).c, i3 = x.s, j = y4.s, k2 = x.e, l4 = y4.e;
  if (!xc2[0] || !yc2[0]) return !xc2[0] ? !yc2[0] ? 0 : -j : i3;
  if (i3 != j) return i3;
  isneg = i3 < 0;
  if (k2 != l4) return k2 > l4 ^ isneg ? 1 : -1;
  j = (k2 = xc2.length) < (l4 = yc2.length) ? k2 : l4;
  for (i3 = -1; ++i3 < j; ) {
    if (xc2[i3] != yc2[i3]) return xc2[i3] > yc2[i3] ^ isneg ? 1 : -1;
  }
  return k2 == l4 ? 0 : k2 > l4 ^ isneg ? 1 : -1;
};
P.div = function(y4) {
...
P.sqrt = function() {
  var r2, c3, t2, x = this, Big2 = x.constructor, s2 = x.s, e2 = x.e, half = new Big2("0.5");
...
P.times = P.mul = function(y4) {
  var c3, x = this, Big2 = x.constructor, xc2 = x.c, yc2 = (y4 = new Big2(y4)).c, a = xc2.length, b = yc2.length, i3 = x.e, j = y4.e;
  y4.s = x.s == y4.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y4.c = [y4.e = 0];
    return y4;
  ...
  for (c3 = new Array(j = a + b); j--; ) c3[j] = 0;
  for (i3 = b; i3--; ) {
    b = 0;
    for (j = a + i3; j > i3; ) {
      b = c3[j] + yc2[i3] * xc2[j - i3 - 1] + b;
      c3[j--] = b % 10;
      b = b / 10 | 0;
    }
    c3[j] = b;
...
var NetworkUtil2 = {
  ...
  onSwitchNetwork({ network, ignoreSwitchConfirmation = false }) {
    ...
    const isSupportedForAuthConnector = ConstantsUtil.AUTH_CONNECTOR_SUPPORTED_CHAINS.find((c3) => c3 === network.chainNamespace);
...
var controller8 = {
  ...
  getAuthConnector(chainNamespace) {
    ...
    const authConnector = state14.connectors.find((c3) => c3.id === ConstantsUtil.CONNECTOR_ID.AUTH);
    if (!authConnector) {
      return void 0;
    }
  ...
  getAnnouncedConnectorRdns() {
    return state14.connectors.filter((c3) => c3.type === "ANNOUNCED").map((c3) => {
      var _a;
      return (_a = c3.info) == null ? void 0 : _a.rdns;
    });
  },
  getConnectorById(id) {
    return state14.allConnectors.find((c3) => c3.id === id);
  },
  getConnector(id, rdns) {
    const connectorsByNamespace = state14.allConnectors.filter((c3) => c3.chain === ChainController.state.activeChain);
    return connectorsByNamespace.find((c3) => {
      var _a;
      return c3.explorerId === id || ((_a = c3.info) == null ? void 0 : _a.rdns) === rdns;
    });
  },
...
(function() {
  ...
  }, i3.prototype.setItem = function(e2, n2) {
    this[e2] = String(n2);
...
function Zi(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c3 = (s2 + 8) % 10, a = (s2 + 2) % 10, u2 = n2[a], l4 = n2[a + 1], f6 = rr(u2, l4, 1) ^ n2[c3], h4 = or(u2, l4, 1) ^ n2[c3 + 1];
      for (let y4 = 0; y4 < 50; y4 += 10) t2[s2 + y4] ^= f6, t2[s2 + y4 + 1] ^= h4;
    }
    let o2 = t2[2], i3 = t2[3];
    for (let s2 = 0; s2 < 24; s2++) {
      const c3 = er[s2], a = rr(o2, i3, c3), u2 = or(o2, i3, c3), l4 = tr[s2];
      o2 = t2[l4], i3 = t2[l4 + 1], t2[l4] = a, t2[l4 + 1] = u2;
    }
    for (let s2 = 0; s2 < 50; s2 += 10) {
      for (let c3 = 0; c3 < 10; c3++) n2[c3] = t2[s2 + c3];
      for (let c3 = 0; c3 < 10; c3++) t2[s2 + c3] ^= ~n2[(c3 + 2) % 10] & n2[(c3 + 4) % 10];
    }
...
var En = class _En extends ke {
  ...
  update(e2) {
    ...
    for (let i3 = 0; i3 < o2; ) {
      ...
      for (let c3 = 0; c3 < s2; c3++) r2[this.pos++] ^= e2[i3++];
...
var Es = (t2, e2) => {
  function n2(r2, ...o2) {
    ...
    return { encrypt(l4, f6) {
      ...
      return a = true, tt(l4), c3(s2.encrypt.length, f6), s2.encrypt(l4, f6);
    }, decrypt(l4, f6) {
      if (tt(l4), i3 && l4.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c3(s2.decrypt.length, f6), s2.decrypt(l4, f6);
    } };
  }
...
function Ir(t2, e2, n2, r2) {
  ...
  const o2 = BigInt(32), i3 = BigInt(4294967295), s2 = Number(n2 >> o2 & i3), c3 = Number(n2 & i3), a = r2 ? 4 : 0, u2 = r2 ? 0 : 4;
  t2.setUint32(e2 + a, s2, r2), t2.setUint32(e2 + u2, c3, r2);
}
function vs(t2) {
...
function Is(t2, e2, n2, r2, o2, i3, s2, c3) {
  const a = o2.length, u2 = new Uint8Array(ge), l4 = mt(u2), f6 = Ye(o2) && Ye(i3), h4 = f6 ? mt(o2) : Tr, y4 = f6 ? mt(i3) : Tr;
  for (let E2 = 0; E2 < a; s2++) {
    if (t2(e2, n2, r2, l4, s2, c3), s2 >= Ur) throw new Error("arx: counter overflow");
    const p = Math.min(ge, a - E2);
    if (f6 && p === ge) {
      const d2 = E2 / 4;
      if (E2 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v = 0, m2; v < Bs; v++) m2 = d2 + v, y4[m2] = h4[m2] ^ l4[v];
      E2 += ge;
      continue;
    }
...
function Ns(t2, e2) {
  ...
  return Fe(o2), Fe(s2), Ar(i3), Ar(n2), (c3, a, u2, l4, f6 = 0) => {
    tt(c3), tt(a), tt(u2);
    const h4 = u2.length;
    ...
    const y4 = [];
    let E2 = c3.length, p, d2;
    if (E2 === 32) y4.push(p = Ze(c3)), d2 = As;
    else if (E2 === 16 && n2) p = new Uint8Array(32), p.set(c3), p.set(c3, 16), d2 = Os, y4.push(p);
    ...
    const O2 = mt(a);
    return Is(t2, d2, v, O2, u2, l4, f6, s2), jt(...y4), l4;
  };
}
...
var Us = class {
  constructor(e2) {
    ...
    const n2 = F(e2, 0), r2 = F(e2, 2), o2 = F(e2, 4), i3 = F(e2, 6), s2 = F(e2, 8), c3 = F(e2, 10), a = F(e2, 12), u2 = F(e2, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s2 << 12) & 255, this.r[5] = s2 >>> 1 & 8190, this.r[6] = (s2 >>> 14 | c3 << 2) & 8191, this.r[7] = (c3 >>> 11 | a << 5) & 8065, this.r[8] = (a >>> 8 | u2 << 8) & 8191, this.r[9] = u2 >>> 5 & 127;
    for (let l4 = 0; l4 < 8; l4++) this.pad[l4] = F(e2, 16 + 2 * l4);
  }
  process(e2, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s2 } = this, c3 = s2[0], a = s2[1], u2 = s2[2], l4 = s2[3], f6 = s2[4], h4 = s2[5], y4 = s2[6], E2 = s2[7], p = s2[8], d2 = s2[9], v = F(e2, n2 + 0), m2 = F(e2, n2 + 2), O2 = F(e2, n2 + 4), N = F(e2, n2 + 6), $ = F(e2, n2 + 8), B3 = F(e2, n2 + 10), A2 = F(e2, n2 + 12), T = F(e2, n2 + 14);
    let S2 = i3[0] + (v & 8191), L = i3[1] + ((v >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O2 << 6) & 8191), _ = i3[3] + ((O2 >>> 7 | N << 9) & 8191), j = i3[4] + ((N >>> 4 | $ << 12) & 8191), g = i3[5] + ($ >>> 1 & 8191), w = i3[6] + (($ >>> 14 | B3 << 2) & 8191), b = i3[7] + ((B3 >>> 11 | A2 << 5) & 8191), I2 = i3[8] + ((A2 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o2), x = 0, C4 = x + S2 * c3 + L * (5 * d2) + U4 * (5 * p) + _ * (5 * E2) + j * (5 * y4);
    x = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h4) + w * (5 * f6) + b * (5 * l4) + I2 * (5 * u2) + R3 * (5 * a), x += C4 >>> 13, C4 &= 8191;
    let P4 = x + S2 * a + L * c3 + U4 * (5 * d2) + _ * (5 * p) + j * (5 * E2);
    x = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y4) + w * (5 * h4) + b * (5 * f6) + I2 * (5 * l4) + R3 * (5 * u2), x += P4 >>> 13, P4 &= 8191;
    let k2 = x + S2 * u2 + L * a + U4 * c3 + _ * (5 * d2) + j * (5 * p);
    x = k2 >>> 13, k2 &= 8191, k2 += g * (5 * E2) + w * (5 * y4) + b * (5 * h4) + I2 * (5 * f6) + R3 * (5 * l4), x += k2 >>> 13, k2 &= 8191;
    let M3 = x + S2 * l4 + L * u2 + U4 * a + _ * c3 + j * (5 * d2);
    x = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p) + w * (5 * E2) + b * (5 * y4) + I2 * (5 * h4) + R3 * (5 * f6), x += M3 >>> 13, M3 &= 8191;
    let D = x + S2 * f6 + L * l4 + U4 * u2 + _ * a + j * c3;
    x = D >>> 13, D &= 8191, D += g * (5 * d2) + w * (5 * p) + b * (5 * E2) + I2 * (5 * y4) + R3 * (5 * h4), x += D >>> 13, D &= 8191;
    let z = x + S2 * h4 + L * f6 + U4 * l4 + _ * u2 + j * a;
    x = z >>> 13, z &= 8191, z += g * c3 + w * (5 * d2) + b * (5 * p) + I2 * (5 * E2) + R3 * (5 * y4), x += z >>> 13, z &= 8191;
    let Z2 = x + S2 * y4 + L * h4 + U4 * f6 + _ * l4 + j * u2;
    x = Z2 >>> 13, Z2 &= 8191, Z2 += g * a + w * c3 + b * (5 * d2) + I2 * (5 * p) + R3 * (5 * E2), x += Z2 >>> 13, Z2 &= 8191;
    let st2 = x + S2 * E2 + L * y4 + U4 * h4 + _ * f6 + j * l4;
    x = st2 >>> 13, st2 &= 8191, st2 += g * u2 + w * a + b * c3 + I2 * (5 * d2) + R3 * (5 * p), x += st2 >>> 13, st2 &= 8191;
    let W = x + S2 * p + L * E2 + U4 * y4 + _ * h4 + j * f6;
    x = W >>> 13, W &= 8191, W += g * l4 + w * u2 + b * a + I2 * c3 + R3 * (5 * d2), x += W >>> 13, W &= 8191;
    let J2 = x + S2 * d2 + L * p + U4 * E2 + _ * y4 + j * h4;
    x = J2 >>> 13, J2 &= 8191, J2 += g * f6 + w * l4 + b * u2 + I2 * a + R3 * c3, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P4 += x, i3[0] = C4, i3[1] = P4, i3[2] = k2, i3[3] = M3, i3[4] = D, i3[5] = z, i3[6] = Z2, i3[7] = st2, i3[8] = W, i3[9] = J2;
  }
  finalize() {
    const { h: e2, pad: n2 } = this, r2 = new Uint16Array(10);
    let o2 = e2[1] >>> 13;
    e2[1] &= 8191;
    for (let c3 = 2; c3 < 10; c3++) e2[c3] += o2, o2 = e2[c3] >>> 13, e2[c3] &= 8191;
    e2[0] += o2 * 5, o2 = e2[0] >>> 13, e2[0] &= 8191, e2[1] += o2, o2 = e2[1] >>> 13, e2[1] &= 8191, e2[2] += o2, r2[0] = e2[0] + 5, o2 = r2[0] >>> 13, r2[0] &= 8191;
    for (let c3 = 1; c3 < 10; c3++) r2[c3] = e2[c3] + o2, o2 = r2[c3] >>> 13, r2[c3] &= 8191;
    r2[9] -= 8192;
    let i3 = (o2 ^ 1) - 1;
    for (let c3 = 0; c3 < 10; c3++) r2[c3] &= i3;
    i3 = ~i3;
    for (let c3 = 0; c3 < 10; c3++) e2[c3] = e2[c3] & i3 | r2[c3];
    ...
    let s2 = e2[0] + n2[0];
    e2[0] = s2 & 65535;
    for (let c3 = 1; c3 < 8; c3++) s2 = (e2[c3] + n2[c3] | 0) + (s2 >>> 16) | 0, e2[c3] = s2 & 65535;
    jt(r2);
  }
  update(e2) {
    Or(this);
...
function _s(t2, e2, n2, r2, o2, i3 = 20) {
  let s2 = t2[0], c3 = t2[1], a = t2[2], u2 = t2[3], l4 = e2[0], f6 = e2[1], h4 = e2[2], y4 = e2[3], E2 = e2[4], p = e2[5], d2 = e2[6], v = e2[7], m2 = o2, O2 = n2[0], N = n2[1], $ = n2[2], B3 = s2, A2 = c3, T = a, S2 = u2, L = l4, U4 = f6, _ = h4, j = y4, g = E2, w = p, b = d2, I2 = v, R3 = m2, x = O2, C4 = N, P4 = $;
  ...
  let k2 = 0;
  r2[k2++] = s2 + B3 | 0, r2[k2++] = c3 + A2 | 0, r2[k2++] = a + T | 0, r2[k2++] = u2 + S2 | 0, r2[k2++] = l4 + L | 0, r2[k2++] = f6 + U4 | 0, r2[k2++] = h4 + _ | 0, r2[k2++] = y4 + j | 0, r2[k2++] = E2 + g | 0, r2[k2++] = p + w | 0, r2[k2++] = d2 + b | 0, r2[k2++] = v + I2 | 0, r2[k2++] = m2 + R3 | 0, r2[k2++] = O2 + x | 0, r2[k2++] = N + C4 | 0, r2[k2++] = $ + P4 | 0;
}
...
function _r(t2, e2, n2, r2, o2) {
  ...
  const c3 = new Uint8Array(16), a = gs(c3);
  Ir(a, 0, BigInt(o2 ? o2.length : 0), true), Ir(a, 8, BigInt(r2.length), true), s2.update(c3);
  const u2 = s2.digest();
  return jt(i3, c3), u2;
}
var Cs = (t2) => (e2, n2, r2) => ({ encrypt(i3, s2) {
  ...
  return s2.set(u2, c3), jt(u2), s2;
}, decrypt(i3, s2) {
  s2 = Br(i3.length - 16, s2, false);
  const c3 = i3.subarray(0, -16), a = i3.subarray(-16), u2 = _r(t2, e2, n2, c3, r2);
...
var Lr = class extends ke {
  ...
  _cloneInto(e2) {
    ...
    const { oHash: n2, iHash: r2, finished: o2, destroyed: i3, blockLen: s2, outputLen: c3 } = this;
    return e2 = e2, e2.finished = o2, e2.destroyed = i3, e2.blockLen = s2, e2.outputLen = c3, e2.oHash = n2._cloneInto(e2.oHash), e2.iHash = r2._cloneInto(e2.iHash), e2;
  }
  destroy() {
...
var qs = class extends ke {
  ...
  update(e2) {
    ...
    const i3 = e2.length;
    for (let s2 = 0; s2 < i3; ) {
      const c3 = Math.min(o2 - this.pos, i3 - s2);
      if (c3 === o2) {
        const a = Pe(e2);
        for (; o2 <= i3 - s2; s2 += o2) this.process(a, s2);
        continue;
      }
      r2.set(e2.subarray(s2, s2 + c3), this.pos), this.pos += c3, s2 += c3, this.pos === o2 && (this.process(n2, 0), this.pos = 0);
    }
  ...
  _cloneInto(e2) {
    ...
    const { blockLen: n2, buffer: r2, length: o2, finished: i3, destroyed: s2, pos: c3 } = this;
    return e2.length = o2, e2.pos = c3, e2.finished = i3, e2.destroyed = s2, o2 % n2 && e2.buffer.set(r2), e2;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e2, B: n2, C: r2, D: o2, E: i3, F: s2, G: c3, H: a } = this;
    return [e2, n2, r2, o2, i3, s2, c3, a];
  }
  set(e2, n2, r2, o2, i3, s2, c3, a) {
    this.A = e2 | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = i3 | 0, this.F = s2 | 0, this.G = c3 | 0, this.H = a | 0;
  }
  process(e2, n2) {
    ...
    let { A: r2, B: o2, C: i3, D: s2, E: c3, F: a, G: u2, H: l4 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h4 = ct(c3, 6) ^ ct(c3, 11) ^ ct(c3, 25), y4 = l4 + h4 + Ds(c3, a, u2) + Ks[f6] + bt[f6] | 0, p = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
      l4 = u2, u2 = a, a = c3, c3 = s2 + y4 | 0, s2 = i3, i3 = o2, o2 = r2, r2 = y4 + p | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i3 = i3 + this.C | 0, s2 = s2 + this.D | 0, c3 = c3 + this.E | 0, a = a + this.F | 0, u2 = u2 + this.G | 0, l4 = l4 + this.H | 0, this.set(r2, o2, i3, s2, c3, a, u2, l4);
  }
  roundClean() {
    bt.fill(0);
  }
...
function Vt(t2) {
  ...
  for (let o2 = 0, i3 = 0; o2 < n2; o2++, i3 += 2) {
    const s2 = Cr(t2.charCodeAt(i3)), c3 = Cr(t2.charCodeAt(i3 + 1));
...
function Dt(t2, e2, n2 = {}) {
  const r2 = (o2, i3, s2) => {
    ...
    const a = t2[o2];
    if (!(s2 && a === void 0) && !c3(a, t2)) throw new Error("param " + String(o2) + " is invalid. Expected " + i3 + ", got " + a);
  };
...
function nn(t2, e2) {
  ...
  for (; n2 !== q; ) {
    const c3 = r2 / n2, a = r2 % n2, u2 = o2 - i3 * c3;
...
function rc(t2) {
  ...
  const i3 = (n2 + H) / At;
  return function(c3, a) {
    if (c3.pow(a, e2) === c3.neg(c3.ONE)) throw new Error("Cannot find square root");
    let u2 = r2, l4 = c3.pow(c3.mul(c3.ONE, o2), n2), f6 = c3.pow(a, i3), h4 = c3.pow(a, n2);
    for (; !c3.eql(h4, c3.ONE); ) {
      if (c3.eql(h4, c3.ZERO)) return c3.ZERO;
      let y4 = 1;
      for (let p = c3.sqr(h4); y4 < u2 && !c3.eql(p, c3.ONE); y4++) p = c3.sqr(p);
      const E2 = c3.pow(l4, H << BigInt(u2 - y4 - 1));
      l4 = c3.sqr(E2), f6 = c3.mul(f6, E2), h4 = c3.mul(h4, l4), u2 = y4;
    }
    return f6;
  };
}
function oc(t2) {
  ...
  if (t2 % Dr === Mr) {
    const e2 = (t2 - Mr) / Dr;
    return function(r2, o2) {
      const i3 = r2.mul(o2, At), s2 = r2.pow(i3, e2), c3 = r2.mul(o2, s2), a = r2.mul(r2.mul(c3, At), s2), u2 = r2.mul(c3, r2.sub(a, r2.ONE));
...
function ac(t2, e2) {
  const n2 = new Array(e2.length), r2 = e2.reduce((i3, s2, c3) => t2.is0(s2) ? i3 : (n2[c3] = i3, t2.mul(i3, s2)), t2.ONE), o2 = t2.inv(r2);
  return e2.reduceRight((i3, s2, c3) => t2.is0(s2) ? i3 : (n2[c3] = t2.mul(i3, n2[c3]), t2.mul(i3, s2)), o2), n2;
}
function qr(t2, e2) {
...
function Kr2(t2, e2, n2 = false, r2 = {}) {
  ...
  let s2;
  const c3 = Object.freeze({ ORDER: t2, isLE: n2, BITS: o2, BYTES: i3, MASK: Je(o2), ZERO: q, ONE: H, create: (a) => X(a, t2), isValid: (a) => {
    if (typeof a != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a);
    return q <= a && a < t2;
  }, is0: (a) => a === q, isOdd: (a) => (a & H) === H, neg: (a) => X(-a, t2), eql: (a, u2) => a === u2, sqr: (a) => X(a * a, t2), add: (a, u2) => X(a + u2, t2), sub: (a, u2) => X(a - u2, t2), mul: (a, u2) => X(a * u2, t2), pow: (a, u2) => cc(c3, a, u2), div: (a, u2) => X(a * nn(u2, t2), t2), sqrN: (a) => a * a, addN: (a, u2) => a + u2, subN: (a, u2) => a - u2, mulN: (a, u2) => a * u2, inv: (a) => nn(a, t2), sqrt: r2.sqrt || ((a) => (s2 || (s2 = oc(t2)), s2(c3, a))), invertBatch: (a) => ac(c3, a), cmov: (a, u2, l4) => l4 ? u2 : a, toBytes: (a) => n2 ? be(a, i3) : Mt(a, i3), fromBytes: (a) => {
...
function uc(t2, e2, n2 = false) {
  ...
  const s2 = n2 ? ee(t2) : Ot(t2), c3 = X(s2, e2 - H) + H;
...
function dc(t2, e2) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    for (let u2 = 0; u2 < o2; u2++) {
      a = c3, s2.push(a);
      for (let l4 = 1; l4 < i3; l4++) a = a.add(c3), s2.push(a);
      c3 = a.double();
    }
    return s2;
  }, wNAF(n2, r2, o2) {
    const { windows: i3, windowSize: s2 } = on(n2, e2);
    let c3 = t2.ZERO, a = t2.BASE;
    const u2 = BigInt(2 ** n2 - 1), l4 = 2 ** n2, f6 = BigInt(n2);
    for (let h4 = 0; h4 < i3; h4++) {
      const y4 = h4 * s2;
      let E2 = Number(o2 & u2);
      o2 >>= f6, E2 > s2 && (E2 -= l4, o2 += ve);
      const p = y4, d2 = y4 + Math.abs(E2) - 1, v = h4 % 2 !== 0, m2 = E2 < 0;
      E2 === 0 ? a = a.add(rn(v, r2[p])) : c3 = c3.add(rn(m2, r2[d2]));
    }
    return { p: c3, f: a };
  }, wNAFUnsafe(n2, r2, o2, i3 = t2.ZERO) {
    const { windows: s2, windowSize: c3 } = on(n2, e2), a = BigInt(2 ** n2 - 1), u2 = 2 ** n2, l4 = BigInt(n2);
    for (let f6 = 0; f6 < s2; f6++) {
      const h4 = f6 * c3;
      if (o2 === Zr) break;
      let y4 = Number(o2 & a);
      if (o2 >>= l4, y4 > c3 && (y4 -= u2, o2 += ve), y4 === 0) continue;
...
function hc(t2, e2, n2, r2) {
  ...
  const o2 = t2.ZERO, i3 = Pr(BigInt(n2.length)), s2 = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c3 = (1 << s2) - 1, a = new Array(c3 + 1).fill(o2), u2 = Math.floor((e2.BITS - 1) / s2) * s2;
  let l4 = o2;
  for (let f6 = u2; f6 >= 0; f6 -= s2) {
    a.fill(o2);
    for (let y4 = 0; y4 < r2.length; y4++) {
      const E2 = r2[y4], p = Number(E2 >> BigInt(f6) & BigInt(c3));
      a[p] = a[p].add(n2[y4]);
    }
    let h4 = o2;
    for (let y4 = a.length - 1, E2 = o2; y4 > 0; y4--) E2 = E2.add(a[y4]), h4 = h4.add(E2);
    if (l4 = l4.add(h4), f6 !== 0) for (let y4 = 0; y4 < s2; y4++) l4 = l4.double();
  }
  return l4;
}
function Wr(t2) {
...
function gc(t2) {
  const e2 = pc(t2), { P: n2 } = e2, r2 = (m2) => X(m2, n2), o2 = e2.montgomeryBits, i3 = Math.ceil(o2 / 8), s2 = e2.nByteLength, c3 = e2.adjustScalarBytes || ((m2) => m2), a = e2.powPminus2 || ((m2) => Hr(m2, n2 - BigInt(2), n2));
  function u2(m2, O2, N) {
    const $ = r2(m2 * (O2 - N));
  ...
  function f6(m2, O2) {
    ...
    for (let j = BigInt(o2 - 1); j >= Ht; j--) {
      ...
      T = r2(D * D), S2 = r2($ * r2(z * z)), B3 = r2(b * R3), A2 = r2(x * (b + r2(l4 * x)));
    }
...
BigInt(8);
function bc(t2) {
  const e2 = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c3 = t2 * t2 % i3 * t2 % i3, a = it(c3, Xr, i3) * c3 % i3, u2 = it(a, yc, i3) * t2 % i3, l4 = it(u2, wc, i3) * u2 % i3, f6 = it(l4, e2, i3) * l4 % i3, h4 = it(f6, n2, i3) * f6 % i3, y4 = it(h4, r2, i3) * h4 % i3, E2 = it(y4, o2, i3) * y4 % i3, p = it(E2, o2, i3) * y4 % i3, d2 = it(p, e2, i3) * l4 % i3;
  return { pow_p_5_8: it(d2, Xr, i3) * t2 % i3, b2: c3 };
}
function Ec(t2) {
...
var lt = { Err: Oc, _tlv: { encode: (t2, e2) => {
  ...
  const c3 = e2.subarray(r2, r2 + s2);
  if (c3.length !== s2) throw new n2("tlv.decode: wrong value length");
  return { v: c3, l: e2.subarray(r2 + s2) };
} }, _int: { encode(t2) {
  const { Err: e2 } = lt;
  ...
  const { v: c3, l: a } = r2.decode(2, i3), { v: u2, l: l4 } = r2.decode(2, a);
...
function Ac(t2) {
  ...
  return { CURVE: e2, ProjectivePoint: h4, normPrivateKeyToScalar: a, weierstrassEquation: s2, isWithinCurveOrder: c3 };
}
function Bc(t2) {
  const e2 = Wr(t2);
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a, normPrivateKeyToScalar: u2, weierstrassEquation: l4, isWithinCurveOrder: f6 } = Ac({ ...e2, toBytes(g, w, b) {
  ...
  class d2 {
    ...
    recoverPublicKey(w) {
      ...
      const P4 = (R3 & 1) === 0 ? "02" : "03", k2 = a.fromHex(P4 + h4(C4)), M3 = c3(C4), D = s2(-x * M3), z = s2(I2 * M3), Z2 = a.BASE.multiplyAndAddUnsafe(k2, D, z);
  ...
  function S2(g, w, b = L) {
    ...
    function st2(W) {
      const J2 = $(W);
      if (!f6(J2)) return;
      const Be3 = c3(J2), zt = a.BASE.multiply(J2).toAffine(), vt = s2(zt.x);
      if (vt === dt) return;
  ...
  function j(g, w, b, I2 = U4) {
    ...
    C4 && (w = e2.hash(w));
    const { r: Z2, s: st2 } = D, W = B3(w), J2 = c3(st2), Be3 = s2(W * J2), zt = s2(Z2 * J2), vt = (_a = a.BASE.multiplyAndAddUnsafe(z, Be3, zt)) == null ? void 0 : _a.toAffine();
...
function rr2(r2, e2) {
  ...
  var a = r2.length, c3 = r2.charAt(0), h4 = Math.log(a) / Math.log(256), l4 = Math.log(256) / Math.log(a);
  function d2(u2) {
    ...
    for (var j = (D - I2) * l4 + 1 >>> 0, T = new Uint8Array(j); I2 !== D; ) {
    ...
    for (var me2 = c3.repeat(b); H2 < j; ++H2) me2 += r2.charAt(T[H2]);
    return me2;
  }
  function g(u2) {
...
var gr = (r2, e2, t2, i3) => {
  ...
  for (let l4 = 0; l4 < n2; ++l4) {
    ...
    c3 = c3 << t2 | d2, a += t2, a >= 8 && (a -= 8, o2[h4++] = 255 & c3 >> a);
  }
  if (a >= t2 || 255 & c3 << 8 - a) throw new SyntaxError("Unexpected end of data");
  return o2;
};
var pr = (r2, e2, t2) => {
  const i3 = e2[e2.length - 1] === "=", s2 = (1 << t2) - 1;
  let n2 = "", o2 = 0, a = 0;
  for (let c3 = 0; c3 < r2.length; ++c3) for (a = a << 8 | r2[c3], o2 += 8; o2 > t2; ) o2 -= t2, n2 += e2[s2 & a >> o2];
...
*/
//# sourceMappingURL=chunk-KPNWQEO4.js.map
